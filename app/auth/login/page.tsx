...
export default function LoginPage() {
  ...
  const { signIn, signInWithGoogle, signInWithGitHub, signInWithFacebook } = useAuth();
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <h1 className="mt-5 text-2xl font-bold text-foreground sm:text-3xl">Welcome Back!</h1>
          <p className="mt-2 text-muted-foreground">Let's get you signed in to continue.</p>
        </div>
